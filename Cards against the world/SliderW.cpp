...
bool SliderW::sliderFunction()//1-music/2-sound
{
	int x;
	double width;
	switch (state)
...
SliderW::SliderW(sf::RenderWindow& win, sf::Texture& pointner_, sf::Texture& line_, sf::SoundBuffer& click_) :pointner(pointner_), line(line_), window(win), click(click_)
{
...
void SliderW::setPosition(int x, int y, double scale)
{
...
void SliderW::setSlider(double x)
{
